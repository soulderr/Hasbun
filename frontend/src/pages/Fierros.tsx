        ...
        {displayedCategories.length > 0 ? (
          <div className="category-list">
            {displayedCategories.map(category => (
              // El Link siempre apunta a /categoria/ID_DE_ESTA_CATEGORIA
              // Esto permite la navegación jerárquica
              <Link to={`/categoria/${category.id_categoria}`} key={category.id_categoria} className="category-item">
          ...
          // Mensaje si no hay categorías principales o subcategorías para mostrar (después de cargar)
